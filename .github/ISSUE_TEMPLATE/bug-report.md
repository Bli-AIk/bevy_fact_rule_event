---
name: Bug report
about: Report a bug or unexpected behavior in bevy_fact_rule_event
...
- bevy_fact_rule_event version (if applicable)
...
3. How are you using bevy_fact_rule_event? (e.g., integrating it into your Bevy app, building as a library)
